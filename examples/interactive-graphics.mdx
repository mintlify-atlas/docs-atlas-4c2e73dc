...
<CardGroup cols={2}>
  ...
  <Card title="Input Blocks Reference" icon="keyboard" href="/reference/blocks/input">
    Complete reference for all input blocks
  </Card>
  <Card title="Logic Blocks Reference" icon="diagram-project" href="/reference/blocks/logic">
