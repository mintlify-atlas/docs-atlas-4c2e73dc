...
<CardGroup cols={2}>
  ...
  <Card title="Math Blocks Reference" icon="calculator" href="/reference/blocks/math">
    Learn about mathematical operations for animations
  </Card>
  <Card title="Animation Blocks Reference" icon="film" href="/reference/blocks/animation">
